...
For environments such as mesh the usage of MCU should be considered as a good alternative to the pure P2P option, this will drastically reduce the resource consumption and bandwidth distribution on the different peer connections.
