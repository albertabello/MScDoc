...
\begin{center}
	...
	\textbf{Rate (Kbit/s)} & 1947.61$\pm232.75$ & 1951.76$\pm234.5$ & 1949.7$\pm233.62$\\
	\textbf{RTT (ms)} & 9.49$\pm2.11$ & 9.64$\pm2.71$ & 9.57$\pm2.41$\\
	\textbf{OWD (ms)} & 4.84$\pm1.5$ & 5.4$\pm1.53$ & 5.12$\pm1.52$\\
	\textbf{Loss (\%)} & 0.005 & 0.007 & 0.006\\
...
\hline
Constraints & Metrics & Machine A & Machine B & Overall\\ \hline
\multirow{3}{*}{1\%} & Rate (Kbit/s) & 1913.59$\pm252.11$ & 1880.24$\pm261.46$ & 1986.91$\pm256.78$\\ \cline{2-5}
 & OWD (ms) & 4.08$\pm1.79$ & 4.03$\pm1.93$ & 4.06$\pm1.86$ \\ \cline{2-5}
 & Loss (\%) & 2.04 & 1.96 & 2 \\ \hline
\multirow{3}{*}{5\%} & Rate (Kbit/s) & 1609.65$\pm158.46$ & 1527.74$\pm178.52$ & 1568.74$\pm178.52$\\ \cline{2-5}
 & OWD (ms) & 3.72$\pm1.82$ & 3.26$\pm1.76$ & 3.49$\pm1.79$ \\ \cline{2-5}
 & Loss (\%) & 9.72 & 9.82 & 9.77 \\ \hline
\multirow{3}{*}{10\%} & Rate (Kbit/s) & 1166.7$\pm145.96$ & 1114.94$\pm177.88$ & 1140.82$\pm161.92$\\ \cline{2-5}
 & OWD (ms) & 3.17$\pm3.8$ & 3.12$\pm2.67$ & 3.14$\pm3.24$ \\ \cline{2-5}
 & Loss (\%) & 18.98 & 19.05 & 19.02 \\ \hline
\multirow{3}{*}{20\%} & Rate (Kbit/s) & 333.34$\pm65.99$ & 295.46$\pm57.98$ & 314.4$\pm61.98$\\ \cline{2-5}
 & OWD (ms) & 2.65$\pm4$ & 2.78$\pm4.06$ & 2.71$\pm4.03$ \\ \cline{2-5}
 & Loss (\%) & 36.08 & 35.95 & 36.01 \\ \hline
\end{tabular}
